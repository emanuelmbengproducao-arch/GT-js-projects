...
// console.log(
//   calcularMedia(alunos[2].notas[0], alunos[2].notas[1], alunos[2].notas[2]),
// );
...
for (let i = 0; alunos.length > i; i++) {
  ...
  if (media >= 6) {
    console.log(`${aluno.nome} a média é ${media} está APROVADO`);
    continue;
  }

  console.log(`${aluno.nome} a média ${media} - REPROVADO`);
}
